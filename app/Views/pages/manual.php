<main>
    <h2>Упутство за додавање и измену рокова</h2>
    <p>Право додавања нових рокова имају сви регистровани чланови. Право измене рокова имају само чланови који су добили одговарајућу дозволу за то. Рок измењујемо тако што одемо на страницу рока ког желимо да изменимо, а затим кликнемо на дугме <em>Измени рок</em> које се налази на дну странице.</p>
